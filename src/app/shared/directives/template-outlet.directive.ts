...
export class TemplateOutletDirective<_T = unknown> implements OnChanges {
  ...
  static ngTemplateContextGuard<T>(_dir: TemplateOutletDirective<T>, _ctx: NzSafeAny): _ctx is NzStringTemplateOutletContext {
    return true;
  }
