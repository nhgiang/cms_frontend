...
@Component({
  selector: 'app-sub-master-create',
  templateUrl: './submaster-create.component.html',
})
export class SubMasterCreateComponent implements OnInit {
  form: FormGroup;
  ...
  constructor(
    ...
    private subMasterApi: SubMasterApiService,
    ...
    this.storageApi
      ...
      .pipe(
        switchMap((url) => {
          ...
          return this.subMasterApi.create(data);
        }),
      ...
      .subscribe(
        () => {
          ...
          this.notification.success(
            'Thành công',
            'Thêm mới thông tin nhân viên thành công!'
          );
        },
        (err) => {
