...
export class PartnersListComponent extends DataTableContainer<any> {
  ...
  edit(data: any) {
    this.modal.create({
      nzTitle: 'Cập nhật thông tin partner',
  ...
  delete(id: string) {
    const next = () => {
      this.notification.success('Thành công', 'Xóa thông tin partner thành công!');
    };
    const err = () => {
      this.notification.error('Thất bại', 'Xóa thông tin partner thất bại!');
    };
